...
class Covenants(unittest.TestCase):
...
class GetCovenant(unittest.TestCase):
    def setUp(self) -> None:
        self.kyrian = "Kyrian"
        self.night_fae = "Night Fae"

    def test_return_type(self):
        self.assertTrue(isinstance(get_covenant(self.kyrian), Covenant))
        self.assertTrue(isinstance(get_covenant(self.night_fae), Covenant))

    def test_return_value(self):
        self.assertTrue(get_covenant(self.night_fae).full_name == self.night_fae)
