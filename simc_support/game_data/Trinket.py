...
trinket_list = [
    ...
    Trinket(  # Ny'alotha
        ...
        max_itemlevel=NYALOTHA+CONTENT_INCREASE,
        max_itemlevel_drop=NYALOTHA,
        agility=False,
        intellect=True,
        strength=False,
        melee=False,
    ...
    Trinket(  # Ny'alotha
        ...
        min_itemlevel=NYALOTHA,
        max_itemlevel=NYALOTHA+CONTENT_INCREASE,
        max_itemlevel_drop=NYALOTHA+CONTENT_INCREASE,
        agility=True,
        intellect=True,
        strength=True,
        melee=False,
    ...
    Trinket(  # Ny'alotha
        ...
        max_itemlevel=NYALOTHA+10+CONTENT_INCREASE,
        max_itemlevel_drop=NYALOTHA+10+CONTENT_INCREASE,
        agility=True,
        intellect=False,
        strength=True,
        melee=False,
