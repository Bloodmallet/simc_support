...
__trinket_list = [
    ...
    Trinket( # atal'dazar
        ...
        TRADER_TOKEN, True, False, False, False, False, source=Sources.DUNGEON
    ),
    Trinket( # atal'dazar
        "Rezan's Gleaming Eye", "158712", DUNGEON_ITEMLEVEL, TITANFORGE_CAP,
        TRADER_TOKEN, False, False, True, False, False, source=Sources.DUNGEON
    ),
    Trinket( # atal'dazar
        "Vessel of Skittering Shadows", "159610", DUNGEON_ITEMLEVEL,
        TITANFORGE_CAP, TRADER_TOKEN, False, True, False, False, False, source=Sources.DUNGEON
    ),
    Trinket( # freehold
    ...
    Trinket( # Shrine of the Storm
        ...
        TRADER_TOKEN, False, True, False, False, False, source=Sources.DUNGEON
    ),
    ...
    Trinket( # The Underrot
        ...
        TRADER_TOKEN, True, False, True, False, False, source=Sources.DUNGEON
    ),
    Trinket( # The Underrot
    ...
    Trinket( # Tol Dagor
        ...
        False, False, True, False, False, source=Sources.DUNGEON
    ),
    Trinket( # Tol Dagor
    ...
    Trinket( # world boss
        ...
        False, True, False, False, False, source=Sources.WORLD_BOSS
    ),
    Trinket( # world boss
        "Drust-Runed Icicle", "161380", 355, TITANFORGE_CAP, TRADER_TOKEN, False,
        True, False, False, False, source=Sources.WORLD_BOSS
    ),
    # Trinket( # ???
    ...
    Trinket( # world boss
        ...
        False, True, False, False, source=Sources.WORLD_BOSS
    ),
    Trinket( # world boss
    ...
    Trinket( # world boss
        ...
        True, False, False, False, False, source=Sources.WORLD_BOSS
    ),
    Trinket( # world boss
    ...
    Trinket( # world boss
        ...
        False, False, True, False, False, source=Sources.WORLD_BOSS
    ),
    Trinket( # world boss
        "Spiritbound Voodoo Burl", "161412", 355, TITANFORGE_CAP, TRADER_TOKEN, True,
        False, False, False, False, source=Sources.WORLD_BOSS
    ),
    Trinket( # world boss
    ...
    Trinket( # inscription
        ...
        355, False, True, False, False, False, source=Sources.PROFESSION
    ),
    Trinket( # inscription
        "Darkmoon Deck: Fathoms", "159125", 355, 355,
        355, True, False, True, False, False, source=Sources.PROFESSION
    ),
    Trinket( # alchemy
        "Surging Alchemist Stone", "152632", 300, 300,
        300, True, True, True, False, False, source=Sources.PROFESSION
    ),
    Trinket( # world quest
        "Plunderbeard's Flask", "158164", WORLD_QUEST_ITEMLEVEL, TITANFORGE_CAP,
        TRADER_TOKEN, True, True, True, False, False, source=Sources.WORLD_QUEST
    ),
    Trinket( # Uldir
        "Frenetic Corpuscle", "160648", 340, TITANFORGE_CAP,
        TRADER_TOKEN, True, False, False, False, False, source=Sources.RAID
    ),
    Trinket( # Uldir
    ...
    Trinket(  # Uldir
        ...
        TRADER_TOKEN, False, True, False, False, False, source=Sources.RAID
    ),
    Trinket( # Tol Dagor
        name="Kul Tiran Cannonball Runner", item_id="159628", min_itemlevel=WORLD_QUEST_ITEMLEVEL, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=TRADER_TOKEN, agility=True, intellect=False, strength=False, melee=False, ranged=False, source=Sources.DUNGEON
    ),
    Trinket(  # Uldir
        name="Vanquished Tendril of G'huun", item_id="160654", min_itemlevel=340, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=TRADER_TOKEN, agility=True, intellect=True, strength=True, melee=True, ranged=True, source=Sources.RAID
    ),
    Trinket(  # world drop
        name="Landoi's Scrutiny", item_id="163935", min_itemlevel=350, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=TRADER_TOKEN, agility=True, intellect=False, strength=False, melee=False, ranged=False, source=Sources.WORLD_DROP
    ),
    Trinket(  # world drop
        name="'Bygone Bee' Almanac", item_id="163936", min_itemlevel=350, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=TRADER_TOKEN, agility=False, intellect=False, strength=True, melee=False, ranged=False, source=Sources.WORLD_DROP
    ),
    Trinket(  # world drop
        name="Leyshock's Grand Compilation", item_id="163937", min_itemlevel=350, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=TRADER_TOKEN, agility=False, intellect=True, strength=False, melee=False, ranged=False, source=Sources.WORLD_DROP
    ),
    Trinket( # wq
        name="Kaja-fied Banana", item_id="161125", min_itemlevel=310, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=TRADER_TOKEN, agility=True, intellect=True, strength=True, melee=True, ranged=True, source=Sources.WORLD_QUEST
    ),
    Trinket(  # uldir
        name="Syringe of Bloodborne Infirmity", item_id="160655", min_itemlevel=340, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=TRADER_TOKEN, agility=False, intellect=False, strength=True, melee=False, ranged=False, source=Sources.RAID
    ),
    Trinket(  # uldir
    ...
    Trinket(  # uldir
        ...
        max_itemlevel_drop=TRADER_TOKEN, agility=False, intellect=True, strength=False, melee=False, ranged=False, source=Sources.RAID
    ),
    Trinket(  # alchemy
        name="Endless Tincture of Fractional Power", item_id="152636", min_itemlevel=300, max_itemlevel=300,
        max_itemlevel_drop=300, agility=True, intellect=True, strength=True, melee=True, ranged=True, source=Sources.PROFESSION
    ),
    ...
    Trinket(  # waycrest manor
        ...
        max_itemlevel_drop=TRADER_TOKEN, agility=False, intellect=False, strength=True, melee=False, ranged=False, source=Sources.DUNGEON
    ),
    Trinket(  # stormsong valley
   ...
   Trinket(  # vol'dun
    ...
    Trinket(  # warfront world boss
        ...
        max_itemlevel_drop=TRADER_TOKEN, agility=False, intellect=True, strength=False, melee=False, ranged=False, source=Sources.WORLD_BOSS
    ),
    Trinket(  # warfront world boss
        name="Lion's Guile", item_id="161473", min_itemlevel=370, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=TRADER_TOKEN, agility=True, intellect=False, strength=False, melee=False, ranged=False, source=Sources.WORLD_BOSS
    ),
    Trinket(  # warfront world boss
        name="Lion's Strength", item_id="161474", min_itemlevel=370, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=TRADER_TOKEN, agility=False, intellect=False, strength=True, melee=False, ranged=False, source=Sources.WORLD_BOSS
    ),
    Trinket(  # warfront world boss
    ...
    Trinket(  # profession alchemy
        ...
        max_itemlevel_drop=355, agility=True, intellect=True, strength=True, melee=True, ranged=True, source=Sources.PROFESSION
    ),
    Trinket(  # World Boss Dark Shore
        name="Ancient Knot of Wisdom", item_id="161417", min_itemlevel=355, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=355, agility=False, intellect=True, strength=False, melee=False, ranged=False, source=Sources.WORLD_BOSS
    ),
    Trinket(  # World Boss Dark Shore
        name="Forest Lord's Razorleaf", item_id="166794", min_itemlevel=355, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=355, agility=True, intellect=False, strength=False, melee=False, ranged=False, source=Sources.WORLD_BOSS
    ),
    Trinket(  # World Boss Dark Shore
        name="Knot of Ancient Fury", item_id="161413", min_itemlevel=355, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=355, agility=False, intellect=False, strength=True, melee=False, ranged=False, source=Sources.WORLD_BOSS
    ),
    Trinket(  # Emissary
        name="Razzashi Tooth Medallion", item_id="165667", min_itemlevel=340, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=370, agility=True, intellect=False, strength=False, melee=False, ranged=False, source=Sources.WORLD_QUEST
    ),
    Trinket(  # Emissary
        name="Moonstone of Zin-Azshari", item_id="165666", min_itemlevel=340, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=370, agility=False, intellect=True, strength=False, melee=False, ranged=False, source=Sources.WORLD_QUEST
    ),
    Trinket(  # Emissary
        name="Ancient Tuskarr Sea Charm", item_id="165661", min_itemlevel=340, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=370, agility=False, intellect=False, strength=True, melee=False, ranged=False, source=Sources.WORLD_QUEST
    ),
    Trinket(  # Emissary
    ...
    Trinket(  # Dazar'Alor
        ...
        max_itemlevel_drop=415, agility=False, intellect=True, strength=False, melee=False, ranged=False, source=Sources.RAID
    ),
    Trinket(  # Dazar'Alor
        name="Everchill Anchor", item_id="165570", min_itemlevel=370, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=415, agility=False, intellect=False, strength=True, melee=False, ranged=False, source=Sources.RAID
    ),
    Trinket(  # Dazar'Alor
    ...
    Trinket(  # Dazar'Alor
        ...
        max_itemlevel_drop=415, agility=True, intellect=False, strength=False, melee=False, ranged=False, source=Sources.RAID
    ),
    Trinket(  # Dazar'Alor
