...
__trinket_list = [
    ...
    Trinket(  # Emissary
        ...
        max_itemlevel_drop=370, agility=True, intellect=False, strength=False, melee=False, ranged=False, source=Source.WORLD_QUEST, active=False
    ),
    Trinket(  # Emissary
        name="Moonstone of Zin-Azshari", item_id="165666", min_itemlevel=340, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=370, agility=False, intellect=True, strength=False, melee=False, ranged=False, source=Source.WORLD_QUEST, active=False
    ),
    Trinket(  # Emissary
        name="Ancient Tuskarr Sea Charm", item_id="165661", min_itemlevel=340, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=370, agility=False, intellect=False, strength=True, melee=False, ranged=False, source=Source.WORLD_QUEST, active=False
    ),
    Trinket(  # Emissary
        name="Sea Giant's Tidestone", item_id="165664", min_itemlevel=340, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=370, agility=False, intellect=True, strength=False, melee=False, ranged=False, source=Source.WORLD_QUEST, active=True
    ),
    Trinket(  # Emissary
        name="Kezan Stamped Bijou", item_id="165662", min_itemlevel=340, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=370, agility=True, intellect=False, strength=False, melee=False, ranged=False, source=Source.WORLD_QUEST, active=True
    ),
    Trinket(  # Emissary
    ...
    Trinket(  # Emissary
        ...
        max_itemlevel_drop=370, agility=False, intellect=False, strength=True, melee=False, ranged=False, source=Source.WORLD_QUEST, active=True
    ),
    Trinket(  # Dazar'Alor
        name="Crest of Pa'ku", item_id="166418", min_itemlevel=370, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=415, agility=False, intellect=True, strength=False, melee=False, ranged=False, source=Source.RAID, active=False
    ),
    Trinket(  # Dazar'Alor
        name="Everchill Anchor", item_id="165570", min_itemlevel=370, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=415, agility=False, intellect=False, strength=True, melee=False, ranged=False, source=Source.RAID, active=False
    ),
    Trinket(  # Dazar'Alor
        name="Grong's Primal Rage", item_id="165574", min_itemlevel=370, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=415, agility=False, intellect=False, strength=True, melee=False, ranged=False, source=Source.RAID, active=True
    ),
    Trinket(  # Dazar'Alor
    ...
    Trinket(  # Dazar'Alor
        ...
        max_itemlevel_drop=415, agility=True, intellect=False, strength=False, melee=False, ranged=False, source=Source.RAID, active=True
    ),
    Trinket(  # Dazar'Alor
        name="Kimbul's Razor Claw", item_id="165579", min_itemlevel=370, max_itemlevel=TITANFORGE_CAP,
        max_itemlevel_drop=415, agility=True, intellect=False, strength=False, melee=False, ranged=False, source=Source.RAID, active=False
    ),
    Trinket(  # Dazar'Alor
    ...
    Trinket(  # Dazar'Alor
        ...
        max_itemlevel_drop=415, agility=False, intellect=True, strength=False, melee=False, ranged=False, source=Source.RAID, active=True
    ),
    Trinket(  # Dazar'Alor
